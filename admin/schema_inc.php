...
// ### Indexes
$indices = [
	'content_title_idx'              => [ 'table' => 'liberty_content', 'cols' => 'title', 'opts' => null ],
	'content_user_idx'               => [ 'table' => 'liberty_content', 'cols' => 'user_id', 'opts' => null ],
	'content_moduser_idx'            => [ 'table' => 'liberty_content', 'cols' => 'modifier_user_id', 'opts' => null ],
	'content_content_hits_idx'       => [ 'table' => 'liberty_content_hits', 'cols' => 'content_id', 'opts' => null ],
	'content_status_idx'             => [ 'table' => 'liberty_content', 'cols' => 'content_status_id', 'opts' => null ],
	'content_alias_title_idx'        => [ 'table' => 'liberty_aliases', 'cols' => 'alias_title', 'opts' => null ],
	'comments_object_idx'            => [ 'table' => 'liberty_comments', 'cols' => 'content_id', 'opts' => null ],
	'comments_parent_idx'            => [ 'table' => 'liberty_comments', 'cols' => 'parent_id', 'opts' => null ],
	'attachments_hits_idx'           => [ 'table' => 'liberty_attachments', 'cols' => 'hits', 'opts' => null ],
	'attachments_user_id_idx'        => [ 'table' => 'liberty_attachments', 'cols' => 'user_id', 'opts' => null ],
	'st_co_foreign_guid_idx'         => [ 'table' => 'liberty_attachments', 'cols' => 'foreign_id, attachment_plugin_guid', 'opts' => [ 'UNIQUE' ] ],
	'structures_root_idx'            => [ 'table' => 'liberty_structures', 'cols' => 'root_structure_id', 'opts' => null ],
	'structures_parent_idx'          => [ 'table' => 'liberty_structures', 'cols' => 'parent_id', 'opts' => null ],
	'structures_content_idx'         => [ 'table' => 'liberty_structures', 'cols' => 'content_id', 'opts' => null ],
...
$gBitInstaller->registerPackageInfo( LIBERTY_PKG_NAME, [
...
// ### Sequences
$sequences = [
	'liberty_content_id_seq'     => [ 'start' => 1 ],
	'liberty_comment_id_seq'     => [ 'start' => 1 ],
	'liberty_files_id_seq'       => [ 'start' => 1 ],
	'liberty_attachments_id_seq' => [ 'start' => 1 ],
...
$gBitInstaller->registerPreferences( LIBERTY_PKG_NAME, [
	...
	[ LIBERTY_PKG_NAME, 'liberty_action_log', 'y' ],
	[ LIBERTY_PKG_NAME, 'liberty_originalize_file_names', 'y' ],
...
$gBitInstaller->registerUserPermissions( LIBERTY_PKG_NAME, [
	...
	[ 'p_liberty_list_content', 'Can list content', 'basic', LIBERTY_PKG_NAME ],
	[ 'p_liberty_admin_comments', 'Can administer comments', 'editors', LIBERTY_PKG_NAME ],
	[ 'p_liberty_post_comments', 'Can post new comments', 'registered', LIBERTY_PKG_NAME ],
	[ 'p_liberty_read_comments', 'Can read comments', 'basic', LIBERTY_PKG_NAME ],
	[ 'p_liberty_edit_comments', 'Can edit all comments', 'editors', LIBERTY_PKG_NAME ],
	[ 'p_liberty_attach_attachments', 'Can create content attachments', 'registered', LIBERTY_PKG_NAME ],
	[ 'p_liberty_detach_attachment', 'Can detach content attachments', 'registered', LIBERTY_PKG_NAME ],
	[ 'p_liberty_delete_attachment', 'Can delete content attachments', 'registered', LIBERTY_PKG_NAME ],
	[ 'p_liberty_print', 'Can print content', 'basic', LIBERTY_PKG_NAME ],
	[ 'p_liberty_enter_html', 'Can enter HTML', 'registered', LIBERTY_PKG_NAME ],
	[ 'p_liberty_edit_content_status', 'Can edit the status of content', 'registered', LIBERTY_PKG_NAME ],
	[ 'p_liberty_edit_all_status', 'Can edit the status of content using all status', 'editors', LIBERTY_PKG_NAME ],
	[ 'p_liberty_view_all_status', 'Can view content with any status', 'editors', LIBERTY_PKG_NAME ],
	[ 'p_liberty_edit_content_owner', 'Can edit the owner of content', 'editors', LIBERTY_PKG_NAME ],
	[ 'p_liberty_edit_content_alias', 'Can edit the alternate titles of content', 'editors', LIBERTY_PKG_NAME ],
	[ 'p_liberty_assign_content_perms', 'Can assign individual content permissions', 'editors', LIBERTY_PKG_NAME ],
	[ 'p_liberty_trusted_editor', 'Can make edits to content as a trusted editor', 'editors', LIBERTY_PKG_NAME ],
]);
